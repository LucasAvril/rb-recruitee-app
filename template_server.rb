...
class GHAapp < Sinatra::Application
  ...
  helpers do
    ...
    def handle_issue_opened_event(payload)
      ...
      @installation_client.create_repository(issue_name, {organization: 'Citreum', autoInit: false, description: "", private: true})
      repo_name = 'Citreum/' + issue_name + ''
      @installation_client.invite_user_to_repository(repo_name, 'Pezio', {})
    end
